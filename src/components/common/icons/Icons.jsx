...
const Icons = ({ name, size = 16, color = "currentColor" }) => {
  const props = { width: size, height: size, fill: "none", stroke: color, strokeWidth: 1.7, strokeLinecap: "round", strokeLinejoin: "round", viewBox: "0 0 24 24" };

  const map = {
    agents: (
      <svg {...props}><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/><circle cx="18" cy="7" r="2"/><path d="M20 5v4"/></svg>
    ),
    models: (
    ...
    published: (
      <svg {...props}><circle cx="12" cy="12" r="9"/><path d="M12 3v9l4 4"/></svg>
    ),
    machines: (
      <svg {...props}><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>
    ),
    queues: (
    ...
    jobs: (
      <svg {...props}><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 9h6M9 12h6M9 15h4"/></svg>
    ),
    executions: (
      <svg {...props}><polygon points="5 3 19 12 5 21 5 3"/></svg>
    ),
    vault: (
      <svg {...props}><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 3"/><circle cx="12" cy="12" r="1" fill={color}/></svg>
    ),
    knowledge: (
    ...
    keystore: (
      <svg {...props}><line x1="18" y1="20" x2="18" y2="4"/><line x1="6" y1="20" x2="6" y2="16"/><line x1="12" y1="20" x2="12" y2="10"/></svg>
    ),
    tenant: (
      <svg {...props}><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>
    ),
    integrations: (
      <svg {...props}><circle cx="12" cy="12" r="9"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
    ),
    search: (
    ...
    moreVertical: (
      <svg {...props}><circle cx="12" cy="5" r="1" fill={color}/><circle cx="12" cy="12" r="1" fill={color}/><circle cx="12" cy="19" r="1" fill={color}/></svg>
    ),
    chevronLeft: (
    ...
    eyeOff: (
      <svg {...props}><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
    ),
    check: (
